...
def create_embed(title, description, ctx):
	...
	embed.set_thumbnail(url=f"https://raw.githubusercontent.com/lilbud/lilbud.github.io/main/assets/img/graphics/bootleg-covers/features/bruce/{title[0:4]}.jpg")
